            ...
            <a href="#" key={name} className="relative group/project border-t last:border-b border-stone-400 border-dotted py-6 md:py-8 lg:py-10 flex flex-col">
              ...
              <div className="relative">
                ...
                <div className="mt-8 md:mt-0 
                  ...
                  md:grid md:[grid-template-columns:1fr_300px_max-content]
                  md:gap-8
                ">
                  <h3 className="text-2xl md:text-3xl lg:text-4xl lg:group-hover/project:pl-4 transition-all duration-700">{name}</h3>
                  <div className="relative">
                    <div className="absolute aspect-video w-full top-1/2 
                      -translate-y-1/2 opacity-0 scale-90
                      group-hover/project:opacity-100 group-hover/project:scale-110
                      transition-all duration-500 z-10
                      lg:group-hover/project:pr-8
                    ">
                      <Image src={image} alt={`${name} image`} className="size-full object-cover"/>
                    </div>
                  </div>
